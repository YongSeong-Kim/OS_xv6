...
printf(int fd, const char *fmt, ...)
{
 ...
 420:	e8 5d fe ff ff       	call   282 <write>
 ...
 498:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 49a:	e8 e3 fd ff ff       	call   282 <write>
  for(i = 0; fmt[i]; i++){
 ...
 533:	57                   	push   %edi
 534:	53                   	push   %ebx
 535:	e8 48 fd ff ff       	call   282 <write>
        while(*s != 0){
 ...
 587:	e8 f6 fc ff ff       	call   282 <write>
        ap++;
 ...
 5b1:	a1 e0 09 00 00       	mov    0x9e0,%eax
{
 ...
 5ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ef:	a3 e0 09 00 00       	mov    %eax,0x9e0
}
 5f4:	5b                   	pop    %ebx
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 e0 09 00 00       	mov    %eax,0x9e0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 711:	09 00 00 
    base.s.size = 0;
 714:	b8 e4 09 00 00       	mov    $0x9e4,%eax
 719:	c7 05 e8 09 00 00 00 	movl   $0x0,0x9e8
 720:	00 00 00 
