...
int pid = fork();
  ...
  20:	74 26                	je     48 <main+0x48>
		{
			printf(1, "Child : %d\n",pid);
		}
		yield();
  22:	e8 3b 03 00 00       	call   362 <yield>
		if(pid > 0)
  27:	83 fb 00             	cmp    $0x0,%ebx
  2a:	7e f4                	jle    20 <main+0x20>
			printf(1,"Parent : %d\n",pid);
